 ...
 * @author chenpeng
 */
public class HungryManJavaSerializeDestructionSingleton implements Serializable {
     ...
     */
    public static final HungryManJavaSerializeDestructionSingleton SINGLETON = new HungryManJavaSerializeDestructionSingleton();

    /**
     * 私有化构造方法 防止外部类通过new的方式实例化对象
     */
    private HungryManJavaSerializeDestructionSingleton() {
