...
public class SingletonDemo {
    ...
    private static void reflexDestruction() {
        try {
            ...
            // 反射
            Class<?> clazz = Class.forName("com.design.mode.creation.singleton.HungryManSingleton");
            // 获取私有构造方法
    ...
    private static void reflex() {
        try {
            ...
            // 反射
            Class<?> clazz = Class.forName("com.design.mode.creation.singleton.HungryManDestructionSingleton");
